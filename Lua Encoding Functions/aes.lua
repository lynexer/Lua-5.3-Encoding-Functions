...
//
//  Description:
//      Pure Lua Advanced Encryption Standard modifed to support Lua 5.3
//
//  Original Author:
...
-- mode      - mode of encryption: ecb, cbc(default), ofb, cfb, ctr
--
-- mode and keyLength must be the same for encryption and decryption.
--
function AESEncrypt(password, data, keyLength, mode, iv)
...
-- keyLength - length of aes key: 128(default), 192 or 256 Bit
-- mode      - mode of decryption: ecb, cbc(default), ofb, cfb, ctr
--
-- mode and keyLength must be the same for encryption and decryption.
--
function WESDecrypt(password, data, keyLength, mode, iv)
	local mode = mode or CBCMODE
	local keyLength = keyLength or AES128
